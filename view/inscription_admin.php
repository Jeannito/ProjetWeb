...
<?php include 'includes/entete.php' ?>
 ...
 <body>
    <div class="container">
        ...
        <div class="box">
        <form action="../controller/controller_inscription_admin.php"  name="inscription" role="form" class="form-horizontal" method="post" accept-charset="utf-8">
                <h3>Veuillez remplir ces champs si vous desirez inscrire un nouvelle administrateur:<br /></h3>

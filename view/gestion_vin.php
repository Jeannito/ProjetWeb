...
<div class="container">
    ...
    $vin = ModelVin::GetAllInactiveWine();
    foreach ($vin as $wine) {
    ...
    ?>
          <tr>
           ...
           <td><?php echo $desc;?></td>
           <td>
            <form action="../controller/controller_valider_vin.php"  name="valider" role="form" class="form-horizontal" method="post" accept-charset="utf-8">
            <input   class="btn btn-primary btn btn-primary" type="submit" value="Valider"/>
